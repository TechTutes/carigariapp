...
class _CartState extends State<Cart> {
  ...
  getSelectedList() async{
    ...
    int j=(global.selected.length-1>0)?global.selected.length-1:0;
    if(global.touch!=0){
    ...
    global.touch=0;
        print("${global.touch}this is glo touch in for loop");
                ...
                ? Center(
                  ...
                  itemBuilder: (context, index) { print("executed j ${index}${global.cart.length}");
                    return Card(child:ListTile(
                      ...
                      subtitle: Text(" Price  ₹ "+global.cart[index].data['price']),
                      // dense: true,
                      onTap: (){
